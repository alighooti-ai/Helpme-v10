...
// 📐 CLARIFY: widthPips=200 = ۲۰۰ پیپ استاندارد (GetPipSize=0.0001) = 0.0200
//             Zone 0 برای AUDCAD = [0.91050 .. 0.93050] (نه 0.91250!)
//             ZoneBorderYellowPips=10 = ۱۰ پیپ استاندارد از هر مرز
// ═══════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════
...
struct SymbolZoneCfg
{
   ...
   int    widthPips;   // عرض هر طبقه (پیپ استاندارد) — 200 × GetPipSize(0.0001) = 0.0200 = ۲۰۰ پیپ
   bool   supported;
};
