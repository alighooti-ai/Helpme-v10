//+------------------------------------------------------------------+
//|                                                HelpMe_V14_15.mq5 |
//|                     Combined EA - Ali Naderi v14.15 (EA)         |
//+------------------------------------------------------------------+
#property copyright "HelpMe v14.15 - Ali Naderi"
#property version   "14.15"
// ════════════════════════════════════════════════════════════════════
...
input group "════════ ⚖️ کالیبراسیون EURGBP (Placeholder) ════════"
input double inp_EURGBP_SpikeWarn   = 1.20;  // EURGBP Warning threshold
input double inp_EURGBP_SpikeSig    = 1.20;  // EURGBP Spike threshold
   ...
   string symOverride = "")   // 🆕 v14.00: برای FOREIGN on-demand — سمبلی غیر از _Symbol
{
   ...
   {
      // 🆕 v14.09 P1: کالیبراسیون کامل EURGBP — حرکت آرام فرسایشی
      ...
      th_RedA_ADX = 20.0;  th_RedA_Flow = 4.0;
      th_RedB_ADX = 35.0;  th_RedB_Flow = 7.0;    // بدون تغییر (شاخه فشار بالا)
      th_OrA_ADX  = 17.0;  th_OrA_Flow  = 3.5;
      th_OrB_ADX  = 16.0;  th_OrB_Ts    = 25.0;
      th_OrC_ADX  = 23.0;  th_OrC_Flow  = 6.0; th_OrC_Ts = 20.0;  // بدون تغییر
      th_OrD_ADX  = 20.0;  th_OrD_Ts    = 30.0;
      th_Y2_ADX   = 14.0;  th_Y2_Flow   = 2.5;
      th_Y3_Flow  = 5.5;   th_Y3_Ts     = 28.0;   // بدون تغییر
      th_Y4_ADX   = 17.0;  th_Y4_Ts     = 40.0;   // بدون تغییر
      th_Y5_ADX   = 29.0;  th_Y5_Flow   = 6.0;    // بدون تغییر
   }
...
void Spike_GetThresholds(string sym, double &th_warn, double &th_spike)
{
   ...
   else if(s == "EURGBP")
   {
      ...
      // حرکت کند EURGBP — Warning == Spike یعنی مرحله Warning وجود ندارد
      th_warn  = inp_EURGBP_SpikeWarn;   // default 1.20
      th_spike = inp_EURGBP_SpikeSig;    // default 1.20
   }
   else if(s == "AUDCAD")
   {
      // 🆕 v14.11: از Inputs می‌خواند (placeholder — کالیبراسیون مستقل بعداً)
