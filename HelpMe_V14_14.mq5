//+------------------------------------------------------------------+
//|                                                HelpMe_V14_14.mq5 |
//|                     Combined EA - Ali Naderi v14.14 (EA)         |
//+------------------------------------------------------------------+
#property copyright "HelpMe v14.14 - Ali Naderi"
#property version   "14.14"
// ════════════════════════════════════════════════════════════════════
...
input int    inp_SpikeCooldownBars  = 0;     // 🆕 Spike Cooldown: کندل‌های متوالی (0=غیرفعال, 2 یا 3 برای فعال)
// --- Spike Weights ---
                                     ...
                                     datetime nowR)
{
   ...
   string remMsg = lbl + " — " + dirLbl + "\n"
      ...
      + "━━━━━━━━━━━━━━━━\n"
      + (level == 2 ? "هنوز نبستی؟ الان ببند." : "هنوز پوزیشن جدید باز نکن.");
   Alert_Send(remMsg);
}
