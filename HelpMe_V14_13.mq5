//+------------------------------------------------------------------+
//|                                                HelpMe_V14_13.mq5 |
//|                     Combined EA - Ali Naderi v14.13 (EA)         |
//+------------------------------------------------------------------+
#property copyright "HelpMe v14.13 - Ali Naderi"
#property version   "14.13"
// ════════════════════════════════════════════════════════════════════
                        ...
                        double adxVal, double flowScore, bool isForBuy)
{
   ...
   // 🆕 v14.13 Patch 8: مدت‌زمان واقعیِ تمیز بودن — از HMRuleState.cleanSince
   datetime dirCleanSince = isForBuy ? g_gbpnzdCleanSinceBuy : g_gbpnzdCleanSinceSell;
   string   cleanDurStr    = SQ_FormatDuration(dirCleanSince);
