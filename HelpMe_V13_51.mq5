...
//+------------------------------------------------------------------+
#property copyright "HelpMe v13.51 - Ali Naderi"
#property version   "13.51"
// ════════════════════════════════════════════════════════════════════
// 📋 v13.51 — 🐛 FIX: GV escape-hatch در GBPNZD_InitReplay حالت GREEN واقعی رو
//   با GV قدیمی اشتباه می‌گرفت (چون هر دو Level=0 دیده می‌شدن) و به Replay کور
//   از کندل‌های بسته برمی‌گشت — دقیقاً همون کوری intra-candle که مکانیزم GV
...
void GBPNZD_GV_Save()
{
   ...
   GlobalVariableSet("HM_GBNZD_Ver", 1351.0);
...
bool GBPNZD_GV_Load()
{
   ...
   if(!GlobalVariableCheck("HM_GBNZD_Ver")) return false;
                      ...
                      int &level, int &reason)
{
   ...
   bool _closeB = (crisisRedH >= 6);
   bool _resume = (cleanH >= 24);
...
void Alert_CheckGBPNZDRule()
{
   ...
   {
      // 🆕 v13.50 RULE-01: منطق مشترک شمارنده‌ها — به‌جای کپی مستقل
