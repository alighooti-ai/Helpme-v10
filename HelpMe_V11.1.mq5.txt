//+------------------------------------------------------------------+
//|                                                 HelpMe_V11.1.mq5  |
//|                 Combined EA - Ali Naderi v11.1  (EA)              |
//+------------------------------------------------------------------+
#property copyright "HelpMe v11.1 - Ali Naderi"
...
input int    BacktestPositionDir  = 0;   // جهت پوزیشن بکتست | 0=Buy  1=Sell
// ─── Zone Lines ────────────────────────────────────────────────
input bool   ShowZoneLines        = true; // رسم خطوط مرز طبقات Zone روی چارت | Draw Zone Lines
input int    ZoneLineCount        = 12;   // تعداد طبقه در هر طرف از Zone 0 | Lines Each Side
input int    ZoneBorderYellowPips = 10;   // فاصله از مرز برای چراغ زرد (پیپ) | Yellow Border Pips
// ─── فیلتر تأیید H1 برای ZOMBIE ────────────────────────────────
input int    ZombieH1ConfirmBars  = 2;   // تعداد H1 متوالی برای تأیید Zone | H1 Confirm Bars: 1=سریع 2=توصیه★ 3=محافظه‌کار
