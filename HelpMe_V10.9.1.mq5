//+------------------------------------------------------------------+
//|                                                  HelpMe_V10.9.mq5 |
//|                 Combined EA - Ali Naderi v10.9   (EA)             |
//+------------------------------------------------------------------+
#property copyright "HelpMe v10.9 - Ali Naderi"
...
// ── v10.9: ZOMBIE H1 Confirmation Filter (کاهش نویز) ────────────────────
input int    ZombieH1ConfirmBars = 2;    // v10.8: تعداد کندل H1 متوالی برای تأیید Zone جدید | 1=سریع | 2=توصیه★ | 3=محافظه‌کار
